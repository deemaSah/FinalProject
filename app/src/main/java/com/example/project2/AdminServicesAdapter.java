...
public class AdminServicesAdapter extends RecyclerView.Adapter<AdminServicesAdapter.ViewHolder>{
    ...
    public AdminServicesAdapter(Context context, List<Hotel> items ){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        cardView.setOnClickListener(view -> {
            ...
            if(position==1) {
                Intent intent = new Intent(context, AdminBeauty.class);
                context.startActivity(intent);
            }
            if(position==2) {
                Intent intent = new Intent(context, AdminSport.class);
                context.startActivity(intent);
            }
            if(position==3) {
                Intent intent = new Intent(context,AdminEnteraement.class);
                context.startActivity(intent);
            }
        });
    }
