...
public class checkinoutActivity2 extends AppCompatActivity {
    TextView date1 ;
    TextView date2;
    EditText cNum;
    EditText cvcCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkinout2);
        ...
        SharedPreferences prefs1 = PreferenceManager.getDefaultSharedPreferences(checkinoutActivity2.this);
    ...
    public  void calendarDialog()
    {
        ...
        calendar1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        checkinoutActivity2.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, setListener
                        , year, month, day);
        ...
        calendar2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        checkinoutActivity2.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, setListener2
                        , year2, month2, day2);
                datePickerDialog.show();
                datePickerDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    protected void onStart( ) {
        ...
        Okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(checkinoutActivity2.this);
                ...
                if(email.contains("admin"))
                {
                    Intent intent = new Intent(checkinoutActivity2.this, roomStatusActivity.class);
                    startActivity(intent);
                }else {
                    Intent intent = new Intent(checkinoutActivity2.this, BookingActivity.class);
                    startActivity(intent);
                }
                dialog.dismiss();
...
//*********************************************************************************************
    ...
    private void addBook(String dateIn, String dateOut, String cardNum,String cvc,String userName,String roomId){
        ...
        RequestQueue queue = Volley.newRequestQueue(checkinoutActivity2.this);
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(checkinoutActivity2.this,
